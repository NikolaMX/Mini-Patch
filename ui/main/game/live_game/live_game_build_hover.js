...
$(document).ready(function () {
        ...
        EnergyWeaponModel = function(state, key) {
            var ammo = ko.pureComputed(function() {return state() && state()[key];}),
                model = {
                    ...
                    ammo_source: ko.pureComputed(function () { return (ammo() && ammo().ammo_source);}),
    ...
    function BuildHoverViewModel() {
        ...
        self.dps = ko.computed(function () { return self.state().dps || ''; }).extend({ numeric: 2 });
        self.max_range =  ko.computed(function () { return self.state().max_range || ''; }).extend({ numeric: 2 });
