...
$(document).ready(function () {
    ...
    function UnitAlertModel() {
        ...
        self.processSpecialWeapon = function (payload) {
            var newAlerts = []
            var matchingAlert = false
            _.forEach(self.specialWeaponAlerts(), function(alert){
                if(alert.index == payload.index){
            ...
            if(!matchingAlert){newAlerts.push(payload)}
            self.specialWeaponAlerts(newAlerts)
        };
