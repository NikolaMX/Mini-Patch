...
$(document).ready(function () {
    ...
    function GamePausedViewModel() {
        ...
        self.tickTimer = function(){
            if(self.ranked() && self.paused()){
                if(self.timer()>0){self.timer(self.timer()-1)}
                _.delay(self.tickTimer,1000)
                return
            }
            self.resetTimer()
        }
